...
$ed = mysqli_query($con, "SELECT * FROM penerimaan_detail a LEFT JOIN barang b ON a.id_barang = b.id_barang LEFT JOIN kategori c ON b.id_kategori = c.id_kategori WHERE a.id_penerimaan_detail = '$id' ")->fetch_array();
?>

<div class="card-body">
    <input type="hidden" name="id_penerimaan_detail" id="id_penerimaan_detail" value="<?= $id ?>">
