<table id="tbl" class="table table-striped table-bordered">
    ...
    <tbody>
        ...
        $jml = mysqli_query($con, "SELECT SUM(jumlah) FROM penerimaan_detail WHERE id_penerimaan = '$id1' ")->fetch_array();

        $data1 = mysqli_query($con, "SELECT * FROM penerimaan_detail a LEFT JOIN barang b ON a.id_barang = b.id_barang LEFT JOIN kategori c ON b.id_kategori = c.id_kategori WHERE a.id_penerimaan = '$id1' ");
        ...
        <?php } ?>
        <tr class="bg-light">
            <td align="center" colspan="4" class="fw-bold">Jumlah Penerimaan</td>
