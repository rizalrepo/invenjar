...
$id = $_GET['id'];
$query = $con->query("SELECT * FROM pengeluaran a LEFT JOIN teknisi b ON a.id_teknisi = b.id_teknisi LEFT JOIN keperluan c ON a.id_keperluan = c.id_keperluan WHERE a.id_pengeluaran ='$id'");
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-building-circle-arrow-right me-2"></i>Edit Data Pengeluaran</h4>
            ...
            <div class="card card-body border border-danger">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control bg-light" value="<?= $row['id_pengeluaran'] ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="id_keperluan" class="form-select select2" style="width: 100%;" required>
                                <?php $data = $con->query("SELECT * FROM keperluan ORDER BY id_keperluan ASC"); ?>
                                <?php foreach ($data as $d) :
                                    if ($d['id_keperluan'] == $row['id_keperluan']) { ?>
                                        <option value="<?= $d['id_keperluan']; ?>" selected="<?= $d['id_keperluan']; ?>"><?= $d['nm_keperluan'] ?></option>
                                    <?php } else { ?>
                                        <option value="<?= $d['id_keperluan'] ?>"><?= $d['nm_keperluan'] ?></option>
                                <?php }
                                endforeach ?>
                            </select>
                            <div class="invalid-feedback">Kolom harus di pilih !</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" novalidate id="form-tambah" method="POST" enctype="multipart/form-data" action="detail/simpan.php">
                    <div class="card-body">
                        <input type="hidden" name="id_pengeluaran" value="<?= $id ?>">
                        <div class="form-group row mb-3">
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE pengeluaran SET 
        tanggal = '$tanggal',
